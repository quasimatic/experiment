import contains from './locators/contains';
...
export default [contains,exactText,value,className,attribute,nodeType,css,visible,leafNodeTarget,inputAfter,shortestPath,index];